...
## How to use
1. Put `LOD_transporter.m`, `Obsolete_node_remover.m` and `content_0.10.9.0.mat` in `[WoWS folder]/bin/[largest number]/res_mods/PnFMods/`
...
**[Download](https://github.com/SEA-group/ContentSDK-0.9.7-fix-tools/releases/download/0.10.9.0/ContentSDK_fix_0.10.9.0.zip)**
