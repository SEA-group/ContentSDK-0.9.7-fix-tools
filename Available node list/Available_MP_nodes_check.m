...
% This script checks available MP nodes in the current game client, and save them in a list

% How to use:
% - use wowsunpack.exe to generate a content list: (can take few minutes)
% - - command: 
%           wowsunpack.exe -l -x bin\5450485\idx -p ..\..\..\res_packages -I content/gameplay/*/misc/* -I content/gameplay/*/technical/* -X *textures* -X *lod* > content_0.11.3.0.txt
...
disp(['Node list saved to content_', gameVersion, '.mat; routine finished.']);
fclose all;
toc
